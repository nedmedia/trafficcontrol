...
#git clone https://github.com/nedmedia/trafficcontrol
git clone $REPO
...
ls -l
${GOPATH}/src/github.com/nedmedia/trafficcontrol/grove/grove -cfg grove.cfg &


sleep 3
curl -H'Host: mem-test.cdn.kabletown.net' -Lsv -r 50000-50009  http://localhost:8080/10Mb.txt

#cd $GOPATH/src/github.com/nedmedia/trafficcontrol/grove/integration_test
...
cp  $GOPATH/src/github.com/nedmedia/trafficcontrol/grove/integration_test/tests/plugins/modify_headers/remap.json /remap.json
pkill -HUP grove
bash $GOPATH/src/github.com/nedmedia/trafficcontrol/grove/integration_test/tests/plugins/modify_headers/test.sh

cp $GOPATH/src/github.com/nedmedia/trafficcontrol/grove/integration_test/tests/plugins/range_req_handler/remap.json /remap.json
pkill -HUP grove
bash $GOPATH/src/github.com/nedmedia/trafficcontrol/grove/integration_test/tests/plugins/range_req_handler/test.sh
